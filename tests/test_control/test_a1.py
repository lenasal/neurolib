...
# set init vars zero everywhere or nowhere
    ...
    def test_A1inputControlForPrecisionCostOnly(self):
        ...
        state2 = func.updateState(model, control2, output_vars)
        ...
        A1_bestControl, A1_bestState, A1_cost, A1_runtime = model.A1(state2, target, control2, c_scheme, u_mat,
                            u_scheme, max_iteration, algorithm_tolerance, start_step, test_step, 2.*controlmax,
                            duration, dur_pre, dur_post, CGVar = None)
    ...
    def test_A1zeroControlForEnergyCostOnly(self):
        ...
        for testcaseind in tests:
            ...
            A1_bestControl, A1_bestState, A1_cost, A1_runtime = model.A1(state2, target, control2, c_scheme, u_mat,
                            u_scheme, max_iteration, algorithm_tolerance, start_step, test_step, 2.*controlmax, duration,
