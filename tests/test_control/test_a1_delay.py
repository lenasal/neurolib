...
# set init vars zero everywhere or nowhere
    ...
    def test_A1rPrecisionCostOnly_InhControlExcCost(self):
                        
        print("test_A1rPrecisionCostOnly_InhControlExcCost for model ", testcaseind)
