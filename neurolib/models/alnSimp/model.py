...
class ALNModelSimp(Model):
    ...
    output_vars = ["rates_exc", "mufe", "seev", "sigmae_f", "tau_exc"]#, "rates_inh"]
    default_output = "rates_exc"
    target_output_vars = ["rates_exc"]#, "rates_inh"]
    input_vars = ["ext_exc_current"]#, "ext_inh_current"]
