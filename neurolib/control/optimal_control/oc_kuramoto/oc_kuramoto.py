...
from neurolib.models.kuramoto.timeIntegration import compute_hx, compute_hx_nw, Dxdoth, Duh


class OcKuramoto(OC):
    """Class for optimal control specific to neurolib's implementation of the Kuramoto model.

    :param model: Instance of Kuramoto model (can describe a single Kuramoto node or a network of coupled Kuramoto nodes.
    :type model:  neurolib.models.kuramoto.model.KuramotoModel
    """
    ...
    def __init__(
        ...
        assert self.model.name == "kuramoto"
    ...
    def Duh(self):
        ...
        :rtype:     np.ndarray of shape 2 x 2
        """
        return Duh(
            self.N,
            self.dim_in,
    ...
    def compute_hx(self):
        ...
        :rtype:         np.ndarray of shape N x T x 2 x 2
        """
        return compute_hx(
            self.model.params.k / self.N,
            self.N,
            self.dim_vars,
            self.T,
            self.get_xs()[:, self.state_vars_dict["theta"], :],
