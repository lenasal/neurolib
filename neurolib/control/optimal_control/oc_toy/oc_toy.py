...
from neurolib.models.toy.timeIntegration import compute_hx, compute_hx_nw, Dxdoth, Duh


class OcToy(OC):
    """Class for optimal control specific to neurolib's implementation of the Toy model."""
    ...
    def get_model_params(self):
        ...
        return (
            ...
            self.model.params.x_ext_baseline,
        )
    ...
    def compute_hx(self):
        """Jacobians of Toy model wrt. its 'state_vars' at each time step.

        :return:        Array that contains Jacobians for all nodes in all time steps.
        :rtype:         np.ndarray of shape N x T x 1 x 1
        """
        return compute_hx(
            self.model_params,
    ...
    def compute_hx_nw(self):
        ...
        :rtype:     np.ndarray of shape N x N x T x 1 x 1
        """
